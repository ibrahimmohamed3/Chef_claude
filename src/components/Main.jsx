...
function Main(){
    ...
    return(
        <main>
          ...
          { mapedIngredient.length >= 1 ? <section>
                <h2>Ingredients on hand:</h2>
                <ul className="ingredients-list" aria-live="polite">{mapedIngredient}</ul>
                {mapedIngredient.length > 3 ? <div className="get-recipe-container">
                    <div>
